...
public class PostgresR2dbcRepositoryWithMixedCaseNamesIntegrationTests
	...
	protected String getCreateTableStatement() {
		return PostgresTestSupport.CREATE_TABLE_LEGOSET_WITH_MIXED_CASE_NAMES;
	}

	@Override
	protected String getDropTableStatement() {
		return PostgresTestSupport.DROP_TABLE_LEGOSET_WITH_MIXED_CASE_NAMES;
	}
}
